...
// (NEW) tiny markdown -> HTML so ** shows as bold inside modal overview
      ...
      {active && (
        <div role="dialog" aria-modal="true" className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative card max-w-4xl w-full p-6 md:p-10">
            ...
            <h3 className="text-2xl font-semibold pr-10">{titleMap[active.name] || active.name.replace(/[-_]/g, " ")}</h3>
            ...
            <div className="mt-6">
              ...
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: basicMdToHtml(
                    active.readme || "README excerpt unavailable. Check the repo for full details, setup, and screenshots."
                  ),
                }}
              />
            </div>
            ...
            <div className="mt-8 flex justify-end">
              <a href={active.html_url} target="_blank" rel="noreferrer" className="btn">
